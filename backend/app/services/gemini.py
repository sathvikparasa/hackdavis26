            ...
            parts=[
                types.Part(
                    text=(
                        ...
                        "- vulnerable_crop must include every crop type this pest can affect, "
                        "including the detection crop when supported by UC IPM. Each item must "
                        "include crop_type, crop damage, likely duration in days, and actionable "
                        "recommendations.\n"
                        "- travel_distance is the farmer alert radius in miles, not an exact "
                        "biological travel measurement. Bias toward broad early warning: choose "
                        "a radius large enough to notify nearby farms that should scout or take "
                        "precautions, even if direct pest movement is uncertain. Avoid tiny "
                        "radii unless the evidence clearly says the risk is limited to the "
                        "source field only.\n"
