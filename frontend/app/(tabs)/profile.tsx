...
// ── Inline auth form shown inside the profile tab ────────────────────────────
...
const styles = StyleSheet.create({
  ...
  authTitle: { fontWeight: '700', fontSize: 28, color: '#191c1a', lineHeight: 34 },
  authSub: { fontWeight: '500', fontSize: 15, color: '#424844', marginBottom: 8 },
  fieldGroup: { gap: 6 },
  ...
  link: { color: '#546522', fontWeight: '600', fontSize: 14, textAlign: 'center', marginTop: 4 },
  ...
  digitInput: {
    ...
    fontSize: 28, color: '#191c1a', textAlign: 'center',
  },
